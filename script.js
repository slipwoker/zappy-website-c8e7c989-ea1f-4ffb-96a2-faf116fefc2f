...
window.onload = function() {
    ...
    try {
        ...
        var pageLang = (htmlEl.getAttribute('lang') || 'pt').toLowerCase().split('-')[0];
        ...
        var forceLang = langMap[pageLang] || 'pt-PT';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'c8e7c989-ea1f-4ffb-96a2-faf116fefc2f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c8e7c989-ea1f-4ffb-96a2-faf116fefc2f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c8e7c989-ea1f-4ffb-96a2-faf116fefc2f';
